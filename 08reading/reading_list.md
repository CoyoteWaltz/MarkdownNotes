...
>
> 还值得说的是我才发现 exa 是自带 [tree view](https://the.exa.website/features/tree-view) 的 `exa --tree --level=2 --long`
>
...
[coolshell 作者左耳朵耗子离世](https://blog.kevinzhow.com/posts/in-memory-of-haoel/zh)
